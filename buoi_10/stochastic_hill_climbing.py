...
def stochastic_hill_climbing(problem: Problem, log_cb=None):
    """Thuật toán Stochastic Hill Climbing cho bài toán 8-puzzle.

    Tại mỗi bước, thuật toán sẽ chọn ngẫu nhiên 1 trạng thái con có giá trị đánh giá tốt hơn (theo hàm heuristic) để tiếp tục.
...
if __name__ == "__main__":
    ...
    res_node, reached_len = stochastic_hill_climbing(problem)
    if res_node == False:
